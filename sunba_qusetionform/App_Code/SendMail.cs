...
public class SendMail
{
    ...
    {
        SendMailUtil(toMail, "", "", subject, body);
    }
    public void MailTo(string toMail, string ccMail, string subject, string body)
    {
        SendMailUtil(toMail, ccMail, "", subject, body);
    }
    public void MailTo(string toMail, string ccMail, string bccMail, string subject, string body)
    {
        SendMailUtil(toMail, ccMail, bccMail, subject, body);
    }

    public void SendMailUtil(string toMail, string ccMail, string bccMail, string subject, string body)
    {
